export const PROFILES = new Set(['particulier', 'entreprise', 'collectivite', 'exploitation'])
export const ZONE_TYPES = new Set(['SUP', 'SOU'])
...
export function computeZoneScore(zone, isIntersecting, typePrio) {
  ...
  + (isIntersecting ? 0.5 : 0) // Bonus intersection
