...
export function searchZone({lon, lat}) {
  ...
  const crise = zones.filter(z => z.niveauAlerte === 'Crise')
  ...
  const alerteRenforcee = zones.filter(z => z.niveauAlerte === 'Alerte renforcée')
  ...
  const alerte = zones.filter(z => z.niveauAlerte === 'Alerte')
  ...
  const vigilance = zones.filter(z => z.niveauAlerte === 'Alerte')
